...
//         for (var k = 1; k < i; k++) {
//             promRes *= i;
//             if (promRes > 10000000000) {promRes = promRes % 10000000000};
//             // console.log(promRes);
//         }
        
//         result += promRes;
//         if (result > 10000000000) {result = result % 10000000000};
//     }
//     result = "" + result;
//     return result.slice(-10);
// };
...
function isPalindrom(phrase) {
    var result = phrase.split('').reverse().join('');
